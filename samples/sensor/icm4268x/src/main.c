...
int main(void)
{
	...
	while (1) {
		...
		printf("icm42688 gyro X = val1 %d val2 %d;"
			"Y = val1 %d val2 %d; Z = val1 %d val2 %d;\n",
			(gyro[0].val1), (gyro[0].val2),
			(gyro[1].val1), (gyro[1].val2),
			(gyro[2].val1), (gyro[2].val2));
		printf("icm42688 accel X = val1 %d val2 %d;"
			"Y = val1 %d val2 %d; Z = val1 %d val2 %d;\n",
		...
		printf("icm42686 gyro X = val1 %d val2 %d;"
			"Y = val1 %d val2 %d; Z = val1 %d val2 %d;\n",
			(gyro[0].val1), (gyro[0].val2),
			(gyro[1].val1), (gyro[1].val2),
			(gyro[2].val1), (gyro[2].val2));
		printf("icm42686 accel X = val1 %d val2 %d;"
			"Y = val1 %d val2 %d; Z = val1 %d val2 %d;\n",
			(accel[0].val1), (accel[0].val2),
			(accel[1].val1), (accel[1].val2),
			(accel[2].val1), (accel[2].val2));
