...
#define BT_L2CAP_I_FRAME_STD_CONTROL_GET_SAR(control) (((control) >> 0x0D) & 0x03)

#define BT_L2CAP_I_FRAME_STD_CONTROL_SET(tx_seq, r, req_seq, sar) ((((tx_seq) & 0x3F) << 0x01) | \
																	(((r) & 0x01) << 0x07) | \
																	(((req_seq) & 0x3F) << 0x08) | \
																	(((sar) & 0x03) << 0x0D))
...
#define BT_L2CAP_I_FRAME_ENH_CONTROL_GET_SAR(control) (((control) >> 0x0D) & 0x03)

#define BT_L2CAP_I_FRAME_ENH_CONTROL_SET(tx_seq, f, req_seq, sar) ((((tx_seq) & 0x3F) << 0x01) | \
																	(((f) & 0x01) << 0x07) | \
																	(((req_seq) & 0x3F) << 0x08) | \
																	(((sar) & 0x03) << 0x0D))
...
#define BT_L2CAP_I_FRAME_EXT_CONTROL_SET(f, tx_seq, sar, req_seq) ((((f) & 0x01) << 0x01) | \
																	(((req_seq) & 0x3FFF) << 0x02) | \
																	(((sar) & 0x03) << 0x10) | \
																	(((tx_seq) & 0x3FFF) << 0x12))
...
#define BT_L2CAP_S_FRAME_STD_CONTROL_SET(s, r, req_seq) (((1) & 0x01) | \
														 (((s) & 0x03) << 0x02) | \
														 (((r) & 0x01) << 0x07) | \
														 (((req_seq) & 0x3F) << 0x08))
...
#define BT_L2CAP_S_FRAME_ENH_CONTROL_SET(s, p, f, req_seq) (((1) & 0x01) | \
															(((s) & 0x03) << 0x02) | \
															(((p) & 0x01) << 0x04) | \
															(((f) & 0x01) << 0x07) | \
															(((req_seq) & 0x3F) << 0x08))
...
#define BT_L2CAP_S_FRAME_EXT_CONTROL_SET(f, req_seq, s, p) (((1) & 0x01) | \
															(((f) & 0x01) << 0x01) | \
															(((req_seq) & 0x3FFF) << 0x02) | \
															(((s) & 0x03) << 0x10) | \
															(((p) & 0x01) << 0x12))
