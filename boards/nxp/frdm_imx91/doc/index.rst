...
The FRDM-IMX91 development board is a low-cost and compact platform designed
to display the most commonly used features of the i.MX 91 applications
processor. The FRDM-IMX91 board is an entry-level development board
...
.. code-block:: console
    ...
    fatload mmc 1:1 0x80000000 zephyr.bin; dcache off; icache flush; go 0x80000000
