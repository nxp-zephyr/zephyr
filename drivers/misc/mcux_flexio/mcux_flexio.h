...
#ifndef ZEPHYR_DRIVERS_MCUX_FLEXIO_H_
#define ZEPHYR_DRIVERS_MCUX_FLEXIO_H_
 ...
 */
struct mcux_flexio_child {
	mcux_flexio_child_isr_t isr;
	void *user_data;
	struct mcux_flexio_child_res res;
};
...
#endif /* ZEPHYR_DRIVERS_MCUX_FLEXIO_H_ */
